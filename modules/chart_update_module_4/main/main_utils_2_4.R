...
initial_time_zero_population = read.fst('./modules/chart_update_module_2/main/initial_time_zero_population10down.fst')


############## Death and Deceased #####################

source('./modules/chart_update_module_2/deaths_module/apply_age_sex_death.R',chdir=T)
...
source('./modules/chart_update_module_2/disease_equation/apply_qrisk_score.R') # an aggregate risk score that is later decomposed
...
source("./modules/chart_update_module_2/disease_equation/risk_qstroke_stroke_1_2.R") # 1.2 includes ethnicity ----

source("./modules/chart_update_module_2/disease_equation/risk_ukbdrs_dementia.R")
source("./modules/chart_update_module_2/disease_equation/risk_drs_dementia.R")


source("./modules/chart_update_module_2/disease_equation/risk_qdiabetes_diabetes.R")
source("./modules/chart_update_module_2/disease_equation/risk_qkidney_chronic_kidney_disease_severe.R")

source("./modules/chart_update_module_2/disease_equation/risk_framingham_hypertension.R")
source("./modules/chart_update_module_2/disease_equation/risk_framingham_atrial_fibrillation.R")
source("./modules/chart_update_module_2/disease_equation/risk_framingham_congestive_heart_failure.R")
message('ere')
source("./modules/chart_update_module_2/disease_equation/risk_qfracture_fracture.R")
source("./modules/chart_update_module_2/disease_equation/risk_qthrombosis_venal_thromboembelism.R")

source("./modules/chart_update_module_2/disease_equation/risk_framingham_peripheral_arterial_disease.R")
source("./modules/chart_update_module_2/disease_equation/risk_framingham_liver_disease.R")

source('./modules/chart_update_module_2/disease_equation/risk_qcancer_lungcancer.R')
source("./modules/chart_update_module_2/disease_equation/site_cancers/renal_cancer.R")
source("./modules/chart_update_module_2/disease_equation/site_cancers/prostate_male_cancer.R")
source("./modules/chart_update_module_2/disease_equation/site_cancers/pancreatic_cancer.R")
source("./modules/chart_update_module_2/disease_equation/site_cancers/ovarian_female_cancer.R")
source("./modules/chart_update_module_2/disease_equation/site_cancers/oral_cancer.R")
source("./modules/chart_update_module_2/disease_equation/site_cancers/oesteogastric_cancer.R")

# source("./modules/chart_update_module_2/disease_equation/site_cancers/breast_female_cancer.R")

source("./modules/chart_update_module_2/disease_equation/site_cancers/colorectal_cancer.R")
source("./modules/chart_update_module_2/disease_equation/site_cancers/blood_cancer.R")
source("./modules/chart_update_module_2/disease_equation/site_cancers/uterine_female_cancer.R")

source("./modules/chart_update_module_2/disease_prevalence.R")

source("./modules/chart_update_module_2/transform_probability.R")
