...
apply_diet_lifestyle_parameter_rank_stability <- function(current_population,
  ...
  current_population <- current_population |> 
    mutate(deprivation =
             case_when(
               mdm_quintile_soa ==  1 ~'Q1_most_deprived',
               mdm_quintile_soa ==  2 ~'Q2',
               mdm_quintile_soa ==  3 ~'Q3',
               mdm_quintile_soa ==  4 ~'Q4',
               mdm_quintile_soa ==  5 ~'Q5_least_deprived'
  ...
  current_population <- current_population |> 
    mutate(geo = case_when(
      Urban_status == 'Urban' ~ 'Urban',
      Urban_status == 'Non-urban' ~ 'Rural'
      ))
