# =============================================================================
# Populate Ovarian Cancer Prevalence
# =============================================================================
# Function to assign Ovarian Cancer prevalence to a synthetic population
# Based on age × HSCT distribution from NI Cancer Registry (2022, 10-year prevalence)
# =============================================================================

library(tidyverse)

#' Populate Ovarian Cancer prevalence in synthetic population
#' 
...
#' @return input_population with added column: ovarian_cancer (year of diagnosis or 0)
#' 
#' @details
#' Total 10-year prevalence (All persons): 1,003 cases
#' 
#' Age distribution:
#' - 0-54: 319 cases
#' - 55-64: 267 cases
...
#' 
#' @examples
#' pop <- populate_ovarian_cancer(initial_population)
#' table(pop$ovarian_cancer > 0)  # Count of cases
...
populate_ovarian_cancer <- function(input_population, 
  ...
  message(sprintf("Populating Ovarian Cancer:"))
  ...
  if (!"ovarian_cancer_year_risk" %in% names(input_population)) {
    # Create random risk score as placeholder
    set.seed(123)  # For reproducibility
    stop('ovarian_cancer_year_risk not found')
    input_population$ovarian_cancer_year_risk <- runif(nrow(input_population))
  }
  
  input_population$ovarian_cancer_percentile <- 
    rank(input_population$ovarian_cancer_year_risk, ties.method = "random") /
    max(rank(input_population$ovarian_cancer_year_risk, ties.method = "random"))
  
  # Assign cancer to top percentile
  input_population <- input_population %>%
    mutate(ovarian_cancer = ifelse(ovarian_cancer_percentile < cancer_prob, year, 0))
  
  # Report results
  n_cases <- sum(input_population$ovarian_cancer > 0)
...
#    age   HSCT               prevalence
#    <ord> <ord>                   <dbl>
#  1 0-54  Belfast HSCT               63
#  2 0-54  Northern HSCT              76
#  3 0-54  South Eastern HSCT         69
#  4 0-54  Southern HSCT              62
#  5 0-54  Western HSCT               49
#  6 55-64 Belfast HSCT               52
#  7 55-64 Northern HSCT              64
#  8 55-64 South Eastern HSCT         58
#  9 55-64 Southern HSCT              52
# 10 55-64 Western HSCT               41
# 11 65-74 Belfast HSCT               43
# 12 65-74 Northern HSCT              52
# 13 65-74 South Eastern HSCT         47
# 14 65-74 Southern HSCT              43
# 15 65-74 Western HSCT               34
# 16 75+   Belfast HSCT               39
# 17 75+   Northern HSCT              47
# 18 75+   South Eastern HSCT         43
# 19 75+   Southern HSCT              39
# 20 75+   Western HSCT               30
