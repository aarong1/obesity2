# =============================================================================
# Populate Kidney Cancer Prevalence
# =============================================================================
# Function to assign Kidney Cancer prevalence to a synthetic population
...
#' Populate Kidney Cancer prevalence in synthetic population
#' 
...
populate_renal_cancer_prevalence <- function(input_population) {
  ...
  if (nrow(cancer_prevalence_data) == 0) {
    stop("No prevalence data found for Kidney Cancer")
  }
...
if (FALSE) {
  ...
  # Populate with Kidney Cancer (10-year prevalence)
  pop_with_cancer <- populate_renal_cancer_prevalence(example_pop)
